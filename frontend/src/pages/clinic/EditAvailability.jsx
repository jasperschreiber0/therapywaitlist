...
const WAIT_OPTIONS = [['UNDER_1_WEEK','Under 1 week'],['ONE_TWO_WEEKS','1–2 weeks'],['TWO_FOUR_WEEKS','2–4 weeks'],['FOUR_EIGHT_WEEKS','4–8 weeks'],['EIGHT_PLUS_WEEKS','8+ weeks']];

export default function EditAvailability() {
  const { clinic_id, ao_id } = useParams();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        <h1 className="text-xl font-semibold text-gray-900 mb-6">Edit availability</h1>
